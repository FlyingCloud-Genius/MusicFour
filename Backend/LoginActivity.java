...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regInfo = connector.getUserInfo();
        String[] str = new String[regInfo.size()];
        for(int i = 0; i < regInfo.size(); i++)
        {
            str[i] = regInfo.get(i);
        }
        DUMMY_CREDENTIALS = str;
        System.out.println("DUMMY_CREDENTIALS: " + DUMMY_CREDENTIALS);
...
//            Log.v("PROJECT4001: ","link to main activity");
